...
>
> **Última sincronização de contrato/registry:** 2026-08-30T10:58:10.431118+00:00
...
\[
\hat p_i=f_\theta\left(X_i(t_0)\right)\approx P\!\left(Y_i=1\mid X_i(t_0)\right)
\]
...
- Construct recommendation do Gate 04: **CALENDAR_DAY_RECOMMENDED_PENDING_BUSINESS_CONFIRMATION**
- Modeling Label Contract após Gate 04B: **CALENDAR_DAY — FROZEN_FOR_MODELING**
- External Olist historical SLA: **NOT_VERIFIED**
- Label finalizado automaticamente pelo Gate 04: **False**
- Label posteriormente congelado pelo Gate 04B: **True — para este case de modelagem**
...
O Registry 1.3 preserva a trilha histórica das questões, incorpora o resultado formal do DQ Gate 05 e distingue explicitamente questões abertas de avaliações já resolvidas.

| canonical_issue_id | canonical_topic | priority | resolution_status | resolved_by | resolution_decision | external_truth_status |
| --- | --- | --- | --- | --- | --- | --- |
| ISSUE-FINANCIAL-001 | financial_reconciliation | MEDIUM | OPEN |  |  |  |
| ISSUE-GEO-001 | geolocation_consolidation | MEDIUM | OPEN |  |  |  |
| ISSUE-GROUND-TRUTH-001 | external_ground_truth | HIGH | OPEN_LIMITATION |  |  | NOT_AVAILABLE |
| ISSUE-IMPUTATION-001 | numeric_imputation_policy | MEDIUM | OPEN |  |  |  |
| ISSUE-MISSINGNESS-001 | conditional_and_task_missingness | HIGH | RESOLVED_ASSESSMENT | DQ_GATE_03B | Assessment closed. Residual missingness continues to treatment-policy stage. |  |
| ISSUE-MULTI-SELLER-001 | multi_seller_representation | MEDIUM | OPEN |  |  |  |
| ISSUE-NUMERIC-TRANSFORMATION-001 | numeric_transformation_policy | MEDIUM | OPEN |  |  |  |
| ISSUE-OBSERVATION-WINDOW-001 | label_observation_window | HIGH | RESOLVED_POLICY | DQ_GATE_04 | Unobserved outcomes must not be encoded as on-time. |  |
| ISSUE-OUTLIERS-001 | extreme_value_policy | MEDIUM | OPEN |  |  |  |
| ISSUE-PAYMENT-AVAILABILITY-001 | payment_point_in_time_availability | MEDIUM | OPEN |  |  |  |
| ISSUE-SELLER-HISTORY-001 | seller_point_in_time_history | HIGH | RESOLVED_PIT_INFRASTRUCTURE | DQ_GATE_05 | Seller purchase history uses purchase_j < purchase_i; outcome-dependent history uses delivery_j < purchase_i. Predictive utility remains untested; MODEL_03 remains locked. |  |
| ISSUE-SHIPPING-LIMIT-001 | shipping_limit_date_provenance | HIGH | OPEN |  |  |  |
| ISSUE-TARGET-001 | label_and_target_semantics | CRITICAL | RESOLVED_MODELING_CONTRACT | DQ_GATE_04B | Use CALENDAR_DAY as primary modeling label. Timestamp strict and +1-day grace remain sensitivity analyses. | OLIST_PRIVATE_SLA_NOT_VERIFIED |
...
<!-- AUTO_GATE05_REGISTRY13_START -->

## 18. DQ Gate 05 — Point-in-Time & Registry 1.3
