...
O Registry 1.2 preserva as questões históricas, mas distingue explicitamente questões abertas de avaliações já resolvidas.
...
| ISSUE-SELLER-HISTORY-001 | seller_point_in_time_history | HIGH | OPEN |  |  |  |
